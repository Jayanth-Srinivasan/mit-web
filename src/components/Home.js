...
function Home() {
    return (
        <section className='bg-gradient-to-br from-blue-200 to-purple-300 h-screen w-screen'>
            <div className='md:w-3/4 w-full h-full mx-auto flex justify-center items-center flex-col'>
                ...
                <div className='flex md:flex-row flex-col justify-evenly items-stretch gap-8'>
                    <div className='px-8 py-12 bg-purple-500/80 w-52 rounded-lg transform transition-all duration-300 hover:scale-110 hover:bg-purple-600/80'>
